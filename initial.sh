...
sudo apt-get install -y kbdd ufw feh apulse i3 i3status dmenu polybar rxvt-unicode tldr lxappearance qt6ct xinit firefox-esr xorg alsa-utils deborphan ncal stow vrms pass xclip at kmon nvtop pulsemixer
